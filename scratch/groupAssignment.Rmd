...
Conflict <- function(round1_matrix, mutation_weights) {
  ...
  combined_matrices <- lapply(mutation_weights, function(candidate_matrix) {
    ...
    cumulative_matrix <- round1_matrix + candidate_matrix # how do I add two matrices?
    return(list(round1_matrix, cumulative_matrix))  # List of round 1 and cumulative matrix for each candidate
  })
